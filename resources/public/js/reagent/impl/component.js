...
if((i < len)){
var k = (ks[i]);
var G__13553 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__13554 = (i + (1));
m = G__13553;
i = G__13554;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__13555 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__13555);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13557 = c;
var G__13557__$1 = (((G__13557 == null))?null:G__13557.prototype);
if((G__13557__$1 == null)){
return null;
} else {
return G__13557__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__13559 = c;
var G__13559__$1 = (((G__13559 == null))?null:G__13559.prototype);
if((G__13559__$1 == null)){
return null;
} else {
return G__13559__$1.render;
}
})() == null)))));
});
...
var G__13561 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__13561) : reagent.impl.component.as_element.call(null,G__13561));
};
...
while (G__13564__i < G__13564__a.length) {G__13564__a[G__13564__i] = arguments[G__13564__i + 0]; ++G__13564__i;}
  args = new cljs.core.IndexedSeq(G__13564__a,0,null);
} 
...
return G__13567__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__13568 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__13569 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__13569);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__13568);
}});
...
var c = this;
var G__13573_13575 = goog.object.get(c,"cljsRatom");
if((G__13573_13575 == null)){
} else {
reagent.ratom.dispose_BANG_(G__13573_13575);
}
...
var renders_13576 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_13577 = cljs.core.first(cljs.core.vals(renders_13576));
...
if((cljs.core.count(renders_13576) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_13576))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_13577)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_13577], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__13578 = o;
goog.object.set(G__13578,cljs.core.name(k),v);
