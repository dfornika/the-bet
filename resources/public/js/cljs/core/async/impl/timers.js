...
var i_16150 = (self__.level + (1));
while(true){
if((i_16150 <= (new_level + (1)))){
(update[i_16150] = self__.header);

var G__16151 = (i_16150 + (1));
i_16150 = G__16151;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_16152 = (update[i]).forward;
(x__$2.forward[i] = (links_16152[i]));
...
var i_16154 = (0);
while(true){
if((i_16154 <= self__.level)){
var links_16155 = (update[i_16154]).forward;
if((x__$1 === (((i_16154 < links_16155.length))?(links_16155[i_16154]):null))){
(links_16155[i_16154] = (x__$1.forward[i_16154]));

var G__16156 = (i_16154 + (1));
i_16154 = G__16156;
continue;
} else {
var G__16157 = (i_16154 + (1));
i_16154 = G__16157;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__16164 = nx;
var G__16165 = (level__$1 - (1));
x = G__16164;
level__$1 = G__16165;
continue;
} else {
var G__16166 = x;
var G__16167 = (level__$1 - (1));
x = G__16166;
level__$1 = G__16167;
continue;
}
