...
var G__13169 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__13169;
continue;
} else {
return ch;
...
var vec__13170 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13170,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq13173){
...
return (function() { 
var G__13178__delegate = function (rdr,_){
...
var G__13178 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__13179__i = 0, G__13179__a = new Array(arguments.length -  1);
while (G__13179__i < G__13179__a.length) {G__13179__a[G__13179__i] = arguments[G__13179__i + 1]; ++G__13179__i;}
  _ = new cljs.core.IndexedSeq(G__13179__a,0,null);
} 
return G__13178__delegate.call(this,rdr,_);};
G__13178.cljs$lang$maxFixedArity = 1;
G__13178.cljs$lang$applyTo = (function (arglist__13180){
var rdr = cljs.core.first(arglist__13180);
var _ = cljs.core.rest(arglist__13180);
return G__13178__delegate(rdr,_);
});
